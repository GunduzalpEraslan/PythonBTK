import pandas as pd 
df = pd.read_csv("Pandas\datasets\imdbb.csv")
...
# 8- Sadece Movie_Title ve Rating kolonunu içeren ilk 10 kaydı alın.

result = df[["Movie_Title","Rating"]].head(10)
...
result = df[(df["Num_Reviews"] >= 100000) | ((df["Rating"] >= 8 ) & (df["Rating"] >= 8 ))][["Movie_Title","Rating","Num_Reviews"]]
